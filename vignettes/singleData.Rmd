...
```{r}
out.hcar  <- getHierLevel(X, y, hierarchy, choice="lambda.1se", selection="hcar", mc.cores=NULL)
...
HCAR <- expression(getHierLevel(X, y, hierarchy, choice="lambda.1se", selection="hcar", mc.cores=NULL))
